<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Online_FooD_Order.User.Cart" %>
                    ...
                    <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <img width="60" src='<%# Online_FooD_Order.Utils.GetImageUrl(Eval("ImageUrl")) %>' />
                                </td>
                                    ...
                                    <div class=" product__details__option">
                                        <div class="quantity">
                                            <div class=" pro-qty">
                                                ...
                                                <asp:RegularExpressionValidator ID="revQuantity" runat="server" ErrorMessage="*" CssClass="text-danger" Font-Size="Small" ValidationExpression="[1-9]*" ControlToValidate="txtQuantity" Display="Dynamic" SetFocusOnError="true" EnableClientScript="true">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove" CommandArgument='<%# Eval("ProductId") %>' OnClientClick="return confirm('Are you sure to remove this item ?');"><i class="fa fa-close"></i></asp:LinkButton></td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                            <tr>

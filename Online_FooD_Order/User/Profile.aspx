<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Online_FooD_Order.User.Profile" %>
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-start">
                                    <div class="image-container">
                                        <img src="<%=Online_FooD_Order.Utils.GetImageUrl(imageUrl) %>" id="imgProfile" style="height: 150px; width: 150px;" class=" img-thumbnail" />
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                        ...
                                        </div><%--Basic User Info Ends--%>
                                           
                                        <%--Order History Starts--%>
                                        <div class="tab-pane fade show " role="tabpanel" id="connectedServices" aria-labelledby="connectedServices-tab">
                                                ...
                                                <ItemTemplate>
                                                    <div class=" container">
                                                        ...
                                                        <asp:Repeater ID="rOrders" runat="server">
                                                            <HeaderTemplate>
                                                                <table class="table table-hover data-table-export table-responsive-sm table-bordered">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("Status") %>' CssClass='<%# Eval("Status").ToString()=="Delivered"?"badge badge-success":"badge badge-danger" %>'></asp:Label>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
